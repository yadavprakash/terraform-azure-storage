...
output "cmk_storage_account_id" {
  value       = join("", azurerm_storage_account.cmk_storage[*].id)
  description = "The ID of the storage account."
}

output "cmk_storage_account_name" {
  value       = join("", azurerm_storage_account.cmk_storage[*].name)
  description = "The name of the storage account."
}
...
output "default_storage_primary_connection_string" {
  value       = join("", azurerm_storage_account.cmk_storage[*].primary_connection_string)
  sensitive   = true
